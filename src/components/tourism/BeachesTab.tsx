...
const BeachesTab: React.FC = () => {
  ...
  // Updated the beach data with direct image URLs that are verified to work
  const beaches: Beach[] = [
    {
      ...
      imageUrl: "https://amarche.it/wp-content/uploads/2022/04/spiaggia-due-sorelle-riviera-del-conero-sirolo-marche-800x533.jpg"
    },
    {
      ...
      imageUrl: "https://amarche.it/wp-content/uploads/2022/04/spiaggia-san-michele-riviera-del-conero-sirolo-marche-800x533.jpg"
    },
    {
      ...
      imageUrl: "https://amarche.it/wp-content/uploads/2022/04/spiagge-sirolo-riviera-del-conero-marche.jpg"
    },
    {
      name: "Sassi Neri",
      type: "Fels",
      ...
      imageUrl: "https://amarche.it/wp-content/uploads/2022/04/spiaggia-sassi-neri-riviera-del-conero-sirolo-marche-800x533.jpg"
    },
    {
      ...
      imageUrl: "https://amarche.it/wp-content/uploads/2022/04/spiaggia-mezzavalle-riviera-del-conero-ancona-marche-800x533.jpg"
    },
    {
      ...
      imageUrl: "https://amarche.it/wp-content/uploads/2022/04/senigallia-bandiera-blu-2021-marche-800x450.jpg"
    }
  ];
              ...
              <div className="flex flex-col md:flex-row gap-4 mb-4 items-start">
                <div className="w-full md:w-1/3 h-40 rounded-md overflow-hidden">
                  <img 
                    ...
                    loading="lazy"
                    onError={(e) => {
                      console.error(`Failed to load image for ${beach.name}`, beach.imageUrl);
                      e.currentTarget.src = "https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?ixlib=rb-4.0.3&auto=format&fit=crop&w=1074&q=80";
                    }}
                  />
                </div>
